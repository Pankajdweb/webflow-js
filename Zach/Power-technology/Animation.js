/* ============================================================
   ANIMATE.JS — Webflow-compatible attribute-driven GSAP system

   WHERE TO PASTE IN WEBFLOW
   ─────────────────────────────────────────────────────────────
   Webflow → Site Settings → Custom Code → Footer Code
   (paste the entire <script> block below, including the tags)

   DO NOT add a separate GSAP script tag — Webflow already
   includes GSAP. This script loads ScrollTrigger from the
   CDN and then boots the system once Webflow signals ready.
   ...
   ANIMATION TYPE  →  data-anim="..."
     ...
     fade-scale     fade + scale up from 88%
     clip-up        clip-path wipe from bottom
   ...
   OPTIONAL MODIFIERS (on the same element)
     ...
     data-anim-duration="1.2"    override duration (default 0.9)
     data-anim-ease="back.out"   any GSAP ease string

   STAGGER (siblings in the same parent animate in sequence)

     Add data-anim-stagger="0.12" to each sibling.
     The script groups them automatically by shared parent.
     Options (type, delay, duration, ease) read from first sibling.

   EXAMPLE

     <!-- Single element -->
     <h2 data-anim="fade-up" data-anim-delay="0.1">Hello</h2>

     <!-- Three cards staggered -->
     <div data-anim="fade-up" data-anim-stagger="0.12">Card 1</div>
     <div data-anim="fade-up" data-anim-stagger="0.12">Card 2</div>
     <div data-anim="fade-up" data-anim-stagger="0.12">Card 3</div>

   ─────────────────────────────────────────────────────────────
   GLOBAL DEFAULTS (edit inside the script)
   ─────────────────────────────────────────────────────────────
     DEFAULTS.duration  → 0.9
     DEFAULTS.ease      → "power3.out"
     DEFAULTS.start     → "top 88%"
     DEFAULTS.once      → true
   ============================================================ */
